...
public final class GrahamScan {
     ...
     */
    protected static boolean areAllCollinear(java.util.List<Point> points) {
     ...
     */
    public static java.util.List<Point> getConvexHull(int[] xs, int[] ys) throws IllegalArgumentException {
     ...
     */
    public static java.util.List<Point> getConvexHull(java.util.List<Point> points) throws IllegalArgumentException {

        java.util.List<Point> sorted = new ArrayList<Point>(getSortedPointSet(points));
     ...
     *               is returned.
     */
    protected static Point getLowestPoint(java.util.List<Point> points) {
